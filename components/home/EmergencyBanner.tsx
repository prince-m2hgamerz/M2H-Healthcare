...
export default function EmergencyBanner() {
  return (
    <div className="bg-gradient-to-r from-[#1a5c4c] to-[#0d3b30] text-white py-2.5 px-4 relative z-40">
      <div className="container-cinematic flex flex-wrap items-center justify-between gap-2">
