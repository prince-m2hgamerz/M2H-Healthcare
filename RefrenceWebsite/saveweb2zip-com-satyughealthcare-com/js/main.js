...
$(".wcs-slide").owlCarousel({
    loop: true,
    margin: 0,
    nav: false,
    dots: true,
    autoplay: $('.wcs-slide').data('auto'),
    smartSpeed: 3000,
    responsive: {
        0: {
            items: 1,
...
// Treatments And Specialization start 

$(".tas-slide").owlCarousel({
    loop: true,
    margin: 0,
    nav: true,
    dots: false,
    autoplay: $('.tas-slide').data('auto'),
    smartSpeed: 3000,
    responsive: {
        0: {
            items: 1,
        ...
        1200: {
            items: $('.tas-slide').data('.service-item')
        }
    }
});

// Treatments And Specialization end


// Treatments And Sp ecialization start 
...
// gallery image show js start 

$(document).ready(function() {
    $('.gallery_section').magnificPopup({
        type: 'image',
        delegate: 'a',
        gallery: {
            enabled: true
